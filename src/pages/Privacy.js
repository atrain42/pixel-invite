      ...
      <React.Fragment>
        <div className={classes.aboutText}>
          ...
          <p>
            ...
            protected. This means that if you don't have the password, there is
            no way to access your site. This allows sensitive information like
            addresses and names to be protected.
            <br />
            <br />
            We take your website down a week after your baby shower has
            concluded. This prevents your shower information from living on the
            internet forever. With Pixel Invite, you never have to worry about
            privacy.
          </p>
          <Link to="/contact">
