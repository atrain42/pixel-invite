        ...
        <React.Fragment>
          <div className={classes.aboutText}>
            ...
            <p>
              ...
              <br />
              <br />
              2. Send any information that is relevant to your baby shower or
              ...
              account information to that platform. The full $50 is due at this
              point.
              <br />
              <br />
              ...
              want. If you want any changes, we will make them and then redeploy
              your site.
            </p>
            <Link to="/contact">
