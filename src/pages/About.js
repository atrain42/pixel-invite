      ...
      <React.Fragment>
        <div className={classes.aboutText}>
          ...
          <p>
            ...
            where to park, then include it on your website. You can also
            advertise your top registry gifts so the guests can get an idea of
            what you need most.
            <br />
            <br />
            The website possibilities are endless, and we have top-notch
            customer service in order to guarantee that your satisfied with your
            site. Just fill out the contact form and we will reach out and start
            building your site!
          </p>
          <Link to="/contact">
